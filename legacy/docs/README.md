...
- [Automation CLI](./guides/automation-cli.md) -- installable command,
  machine-readable stdout, provider selection and health, schemas, strict exit
  policy, stdin workflows, and agent examples.
