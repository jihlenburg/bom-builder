...
- [x] Modernize the CLI around installable, task-focused subcommands
- [x] Add a versioned JSON machine interface with clean stdout/stderr separation
- [x] Make distributor providers independently selectable
- [x] Add provider capability discovery and live health diagnostics
- [x] Add strict completion policies and stable exit codes
- [x] Add stdin/stdout workflows and JSON Schema discovery
- [x] Document and verify the modern CLI for agent-driven automation
- [x] Design stock-aware, evidence-backed alternative-part analysis on top of
      the provider interface
- [x] Keep nested purchase-plan legs currency-consistent with normalized offers
- [x] Preserve provider datasheet/product links in machine and buyer outputs
- [x] Add executable discovery helpers for coding agents
- [x] Add and verify a host-native standalone `bom-builder` binary build
- [x] Complete a repository-wide code review and report prioritized findings
