...
from models import DistributorOffer, PurchaseLeg
...
class TestConvertOfferCurrency:
    def test_converts_priced_offer(self):
        ...
        assert converted.purchase_legs[0].currency == "EUR"
        assert converted.purchase_legs[0].unit_price == pytest.approx(0.91)
        assert converted.purchase_legs[0].extended_price == pytest.approx(91.0)
