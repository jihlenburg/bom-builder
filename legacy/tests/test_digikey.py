...
class TestPricePartViaDigiKey:
    def test_normalizes_successful_offer(self):
        ...
        client.document_links = lambda _product_number: (
            "https://manufacturer.example/part.pdf",
            "https://digikey.example/product",
        )

        offer = price_part_via_digikey(
            agg,
            client,
        ...
        assert offer.datasheet_url == "https://manufacturer.example/part.pdf"
        assert offer.product_url == "https://digikey.example/product"
