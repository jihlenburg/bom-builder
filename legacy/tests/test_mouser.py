...
class TestPricePart:
    def test_uses_cheaper_price_break_overbuy_when_it_reduces_total_spend(self):
            ...
            ("PART1", "Exact"): [
                {
                    ...
                    "Availability": "100 In Stock",
                    "DataSheetUrl": "https://manufacturer.example/part.pdf",
        ...
        assert priced.datasheet_url == "https://manufacturer.example/part.pdf"
        assert priced.product_url == "https://mouser.example/part"
