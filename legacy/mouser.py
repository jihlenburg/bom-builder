...
def _mouser_offer_from_priced(priced: PricedPart) -> DistributorOffer:
    ...
    return DistributorOffer(
        ...
        datasheet_url=priced.datasheet_url,
        product_url=priced.product_url,
...
def price_part(
    ...
    try:
        ...
        priced.datasheet_url = (
            str(mouser_part.get("DataSheetUrl") or "").strip() or None
        )
        priced.product_url = (
            str(mouser_part.get("ProductDetailUrl") or "").strip() or None
        )
